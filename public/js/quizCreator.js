var socket = io();
var questionNum = 1; //Commence à deux parce que la question 1 est déjà présente
...
function addQuestion(){
    ...
    correctLabel.innerHTML = "Réponse correcte (1-4): ";
    ...
    questionsDiv.appendChild(document.createElement('br'));//Crée une pause entre chaque question
    questionsDiv.appendChild(newQuestionDiv);//Ajoute la question div à l'écran
...
function cancelQuiz(){
    if (confirm("Êtes-vous sûr de vouloir sortir ? Tout le travail sera SUPPRIMÉ")) {
